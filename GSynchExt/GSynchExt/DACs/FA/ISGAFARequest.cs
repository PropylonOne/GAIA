...
namespace GSynchExt
{
  ...
  public class ISGAFARequest : PXBqlTable, IBqlTable, IAssign
  {
    ...
    #region ReqDate
    [PXDBDate()]
    [PXUIField(DisplayName = "Req Date")]
    ...
    #region BranchID
    [PX.Objects.GL.Branch(typeof(AccessInfo.branchID), typeof(Search<Branch.branchID>), IsDetail = false, TabOrder = 0)]
    ...
    #region IssueTo
    [PXDBInt()]
    [PXUIField(DisplayName = "Issue To")]
    [PXSelector(typeof(Search<EPEmployee.bAccountID>), SubstituteKey = typeof(EPEmployee.acctName))]
    [PXDefault(typeof(Search<EPEmployee.bAccountID, Where<EPEmployee.userID, Equal<Current<AccessInfo.userID>>>>))]
    ...
    [PXSelector(typeof(Search<EPEmployee.bAccountID>), SubstituteKey = typeof(EPEmployee.acctName))]
    [PXDefault(typeof(Current<ISGAFARequest.issueTo>), PersistingCheck = PXPersistingCheck.Nothing)]

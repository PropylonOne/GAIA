...
namespace GSynchExt
{
  ...
  public class ISGAFARequestLine : PXBqlTable, IBqlTable
  {
    ...
    public abstract class assetID : PX.Data.BQL.BqlInt.Field<assetID> { }
        ...
        ////#region BranchID
        ////[Branch()]
        //[PXDefault(typeof(Parent<ISGAFARequest.branchID>))]
        //[PXParent(typeof(Select<ISGAFARequest, Where<ISGAFARequest.reqNbr, Equal<Current<ISGAFARequestLine.reqNbr>>>>))]
        //public virtual int? BranchID { get; set; }
        //public abstract class branchID : PX.Data.BQL.BqlInt.Field<branchID> { }
        //#endregion

    #region BranchID
    [PX.Objects.GL.Branch(typeof(AccessInfo.branchID), typeof(Search<PX.Objects.GL.Branch.branchID>), IsDetail = true, TabOrder = 0)]
    public virtual int? BranchID { get; set; }
    public abstract class branchID : PX.Data.BQL.BqlInt.Field<branchID> { }
    #endregion

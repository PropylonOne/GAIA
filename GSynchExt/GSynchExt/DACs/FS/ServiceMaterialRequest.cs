...
namespace GSynchExt
{
    ...
    public class ServiceMaterialRequest : PXBqlTable, IBqlTable
    {
        ...
        [PXStringList(
          new string[]
          {
                 GSynchExt.ReqType.InsuranceClaim,
                 GSynchExt.ReqType.WarrantyReplacement,
                 GSynchExt.ReqType.MaterialRequestServices,

          },
          new string[]
          {
                 GSynchExt.Messages.InsuranceClaim,
                 GSynchExt.Messages.WarrantyReplacement,
    ...
    [PXHidden]
    public class CopyDialogInfo2 : PXBqlTable, IBqlTable
    {

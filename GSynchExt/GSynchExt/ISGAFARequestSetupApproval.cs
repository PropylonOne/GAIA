...
{
    [Serializable]
    [PXCacheName("FA Request Approval")]
    public class ISGAFARequestSetupApproval : PXBqlTable, IBqlTable, IAssignedMap
    {
        ...
        #endregion
        // public class AssignmentMapTypeFARequest : PX.Data.BQL.BqlString.Constant<AssignmentMapTypeFARequest> { public AssignmentMapTypeFARequest() : base(typeof(GSynchExt.ISGAFARequest).FullName) { } }

        public static class AssignmentMapType
        {

            public class AssignmentMapTypeFARequest : Constant<string>
            {

...
namespace GSynchExt
{
    ...
    {
        //Issue 
        public const string INIssueReasonCode = "INISSUE";

        //Req Types
        public const string FundTransfer            = "Fund Transfer";
        public const string MaterialRequest         = "Material Request";
        public const string MaterialRequestServices = "GAIA Service Materials";
        public const string InsuranceClaim          = "Insurance Claim";
        public const string WarrantyReplacement     = "Warranty Replacement";

...
namespace PX.Objects.PO
{
    ...
    public class ISGAPOScheduleDelivery : PXBqlTable, IBqlTable
    {
        ...
        [PXDependsOnFields(typeof(ISGAPOScheduleDelivery.orderNbr), typeof(ISGAPOScheduleDelivery.orderType), typeof(ISGAPOScheduleDelivery.deliveryNbr), typeof(ISGAPOScheduleDelivery.deliveryQty))]
